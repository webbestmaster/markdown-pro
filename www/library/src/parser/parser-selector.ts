...
export const olNumericItemRegExp: RegExp = /^\d+\.\s/;
...
export const olBigRomanNumberItemRegExp: RegExp = /^[CDILMVX]+\.\s/;
...
export const olSmallRomanNumberItemRegExp: RegExp = /^[cdilmvx]+\.\s/;
...
export const olBigAlphabetItemRegExp: RegExp = /^[A-Z]+\.\s/;
...
export const olSmallAlphabetItemRegExp: RegExp = /^[a-z]+\.\s/;
